...
static void smart_slider_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj)
{
    ...
    if (!style_inited) {
        ...
        lv_style_set_bg_opa(&local_style, 220);
        lv_style_set_border_width(&local_style, SMALL);
    ...
    lv_obj_t * lv_slider_0 = lv_slider_create(obj);
    lv_obj_set_y(lv_slider_0, 30);
    widget->lv_slider_0 = lv_slider_0;
    lv_obj_add_style(lv_slider_0, &local_style, LV_PART_KNOB | LV_STATE_PRESSED);
    lv_obj_add_style(lv_slider_0, &local_style, LV_PART_INDICATOR);
